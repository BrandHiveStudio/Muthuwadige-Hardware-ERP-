...
| **Displays & Monitory** | Full HD (1920×1080), Touchscreen POS Displays, Tablet Views | HDMI, DisplayPort, VGA |

---

## 2. Step-by-Step Installation Guide

Follow these simple steps to install the ERP on your primary POS counter terminal or back-office server machine:
...
> **Staff Limit Policy:** You can create up to **3 dedicated secondary staff accounts** (e.g., Cashier Counter 1, Cashier Counter 2, Store Manager). All sales and credit settlement transactions automatically record real staff attribution when they log in and process transactions.
...
2. Enter your registered email address (`sanojhardware@gmail.com`).
...
1. **Opening Shift:** Log in with your assigned staff account. Check the dashboard for low stock alerts.
2. **Fast Checkout:** Use the POS barcode scanner for instant line-item addition. Press `F2` or click **Checkout** to process Cash, Card, Credit, or Cheque payments.
3. **Closing Shift:** At the end of the business day, open **Reports** $\rightarrow$ **Shift Closing Report** to reconcile cash in drawer against the recorded POS inflow.
4. **Offline Resilience:** The ERP operates 100% offline without requiring internet. Internet is only utilized for nocturnal email backup transmissions.

---

## 7. Technical Support & Warranty Contact

For hardware integration assistance, peripheral setup, feature customization, or priority technical support:

- **System Integrator:** BrandHive Studio Engineering Team
- **Direct Support Phone:** `+94 77 076 0767`
- **Official Support Email:** `support@brandhivestudio.com`
- **Repository:** `https://github.com/BrandHiveStudio/Muthuwadige-Hardware-ERP-`
